...
@section('content')
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">SCORE BRANDING</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
    ...
    <script>
        PDFObject.embed("{{ asset('src/assets/pdf/IELTS-Band-Score-Conversion-Table.pdf') }}", "#pdf-viewer",{
            pdfOpenParams: {
                toolbar: 0,
                navpanes: 0,
                statusbar: 0,
